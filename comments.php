...
<?php else : // this is displayed if there are no comments so far ?>
	...
	<section id="comments">
		<div class="notice">
			<p class="bottom"><?php _e('', 'reverie') ?></p> <?php /* silence */ ?>
		</div>
	</section>
	<?php endif; ?>
<?php endif; ?>
...
<section id="respond">
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<p><input name="submit" class="button secondary" type="submit" id="submit" tabindex="5" value="<?php _e('Submit Comment', 'reverie'); ?>"></p>
